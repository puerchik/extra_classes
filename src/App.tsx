...
function App() {
    ...
    const [todo, setTodo] = useState<NewTodoType[]>([])
    ...
    function removeTask(taskId: string, todolistId: string) {
        setTodo(todo.map(el => el.todolistId === todolistId
            ? { ...el, tasks: el.tasks.filter(taskItem => taskItem.taskId !== taskId) }
            : el))
    }
    ...
    function changeStatus(id: string, isDone: boolean, todolistId: string) {
        setTodo(todo.map(el => el.todolistId === todolistId ? { ...el, tasks: el.tasks.map(task => task.taskId === id ? { ...task, isDone } : task) } : el))
    }
